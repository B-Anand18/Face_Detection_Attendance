    ...
    for encodeFace, faceLoc in zip(encodeCurrFrame, faceCurrFrame):
        ...
        if matches[matchIndex]:
            ...
            if counter == 0:
                ...
                # cv2.resizeWindow("Face Attendance", 800, 600)
        ...
        if counter != 0:
            if counter == 1:
                ...
                imgStudent = cv2.imdecode(array, cv2.COLOR_BGR2GRAY)
            ...
            if modeType != 3:
                ...
                if counter <= 10:
                    ...
                    offset = (430 - w)//2
                    cv2.putText(imgBackground, str(studentInfo['name']), (880 + offset - 80, 445),
